import { ArrowRight, Calendar, CircleCheck, Link2, MapPin, Plus, Settings2 } from "lucide-react";
        ...
        <div className="w-80 space-y-6">
          <div className="space-y-6">
            ...
            <div className="space-y-5">
              <div className="fllex items-center justify-between gap-4">
                <div className="space-y-1.5">
                  <span className="block font-medium text-zinc-100">Reserva do AirbNb</span>
                  <span className="block text-xs text-zinc-400 truncate">https://www.airbnb.com.br/rooms/6541894651651964865135196546as1d3a2165461as32d1as56113a1sd9</span>
                </div>
